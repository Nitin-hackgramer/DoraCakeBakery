  ...
  const testimonials: Testimonial[] = [
    {
      id: "1",
      name: "Sarah Johnson",
      content: "The cakes from Sweet Crumbs are absolutely divine! I've ordered birthday cakes three years in a row and they never disappoint.",
      rating: 5,
    },
    {
      id: "2",
      ...
      content: "We order pastries weekly for our office meetings and everyone looks forward to Sweet Crumbs day! Fresh, delicious and always on time.",
      rating: 5,
    },
    {
      id: "3",
      name: "Emily Rodriguez",
      content: "Their sourdough bread is the best I've ever tasted. You can tell they put real care into every loaf.",
      rating: 4,
    },
  ];
            ...
            <ScrollReveal delay={300}>
              <div>
                ...
                <p className="text-bakery-brown/80 mb-6">
                  Sweet Crumbs Bakery has been a family-owned business for over a decade. What started as a small operation in our home kitchen has grown into a beloved local bakery that brings joy to our community every day.
                </p>
